...
```text
ichigojam-rs/
├── core/   # no_std 可能な BASIC インタプリタ本体 (ichigojam-core)   → core/README.md
├── app/    # egui デスクトップフロントエンド (ichigojam-app)          → app/README.md
└── web/    # WebAssembly フロントエンド (ichigojam-web)               → web/README.md
```
